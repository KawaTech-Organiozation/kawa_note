...
### 1. Auth (`apps/api/src/modules/auth/`)
...
### 2. Notes (`apps/api/src/modules/notes/`)
...
### 3. Folders (`apps/api/src/modules/folders/`)
...
### 4. Relations (`apps/api/src/modules/relations/`)
...
### 5. Apps (`apps/api/src/modules/apps/`)
...
### Migrations
- Versionadas em `apps/api/prisma/migrations/`
