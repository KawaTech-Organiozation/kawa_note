...
- [ ] Arquivo está no diretório correto (`apps/web/src/components/`, `apps/web/src/hooks/`, `apps/web/src/pages/`, etc.).
...
- `apps/web/src/components/notes/NoteCard.jsx` — ✅ Aprovado
- `apps/web/src/hooks/useNotes.js` — ✅ Aprovado
- `apps/web/src/pages/Notes.jsx` — ✅ Aprovado
