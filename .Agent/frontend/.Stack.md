...
- **Tailwind CSS:** 3.4.17
  ...
  - Estilos globais em `apps/web/src/styles/globals.css`
...
- **@hello-pangea/dnd:** 17.0.0 — arraste de notas/credenciais entre pastas
  - Escolhida por oferecer arraste por teclado nativo (WCAG 2.1 AA é critério
    de HALT) e suporte a toque por long-press
  - Constantes e helpers em `apps/web/src/lib/dnd.js`
  - `DragDropContext` nas páginas; `Droppable` nas pastas; `Draggable` nos itens
  - A alça de arraste deve ser um elemento próprio: `dragHandleProps` injeta
    `role="button"`/`tabIndex`, e no mesmo nó de um botão gera foco aninhado
...
- **@tanstack/react-query:** 5.84.1
  ...
  - Configuração em `apps/web/src/api/`
...
- **Zod:** Validação de schemas
  - Schemas em `apps/web/src/api/` ou `apps/web/src/lib/`
  - Exemplo: `z.object({ title: z.string().min(1) })`

- **React Router DOM:** 6.26.0
  - Roteamento de páginas
  - Configuração em `apps/web/src/App.jsx`
